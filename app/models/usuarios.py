...
class User(UserMixin, db.Model):
    ...
    last_seen = db.Column(db.DateTime(), default=datetime.utcnow) #ultima conexion de mi usaurio 8pm
    ...
    def __init__(self, **kwargs):
        ...
        self.avatar = '{url}/{hash}?s={size}&d={default}&r={rating}'.format(url=url, hash=hash, size=100,
